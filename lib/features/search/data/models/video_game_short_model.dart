...
class VideoGameShortModel {
  VideoGameShortModel(this.remoteId, this.name, this.imageName,
      this.releaseYear, this.platforms);
  ...
  factory VideoGameShortModel.fromJson(Map<String, dynamic> json) =>
      _$VideoGameShortModelFromJson(json);
